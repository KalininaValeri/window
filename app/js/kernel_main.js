 ...
 */
;/* /bitrix/js/main/core/core_fx.min.js?14854478719592*/
;/* /bitrix/js/main/core/core.min.js?148544787170993*/
;/* /bitrix/js/main/core/core_ajax.min.js?148544787120978*/
;/* /bitrix/js/main/json/json2.min.js?14854478713467*/
;/* /bitrix/js/main/core/core_ls.min.js?14854478717365*/
;/* /bitrix/js/main/session.min.js?14854478712511*/
;/* /bitrix/js/main/core/core_window.min.js?148544787174917*/
;/* /bitrix/js/main/core/core_popup.min.js?148544787131170*/
;/* /bitrix/js/main/core/core_date.min.js?148544787134276*/
;/* /bitrix/js/main/utils.min.js?148544787119858*/

;/* Start:"a:4:{s:4:"full";s:48:"/bitrix/js/main/core/core.min.js?148544787170993";s:6:"source";s:28:"/bitrix/js/main/core/core.js";s:3:"min";s:32:"/bitrix/js/main/core/core.min.js";s:3:"map";s:32:"/bitrix/js/main/core/core.map.js";}"*/
(function (window) {
    ...
    var __readyHandler = null, readyBound = false, readyList = [], proxySalt = Math.random(), proxyId = 1, proxyList = [], NODECACHE = {}, deniedEvents = [], eventsList = [], customEvents = {}, garbageCollectors = [], cssList = [], cssInit = false, jsList = [], jsInit = false, bSafari = navigator.userAgent.toLowerCase().indexOf("webkit") != -1, bOpera = navigator.userAgent.toLowerCase().indexOf("opera") != -1, bFirefox = navigator.userAgent.toLowerCase().indexOf("firefox") != -1, bChrome = navigator.userAgent.toLowerCase().indexOf("chrome") != -1, bIE = document.attachEvent && !bOpera, r = {
        ...
        focus: "MouseEvent",
        blur: "MouseEvent"
    }, lastWait = [], CHECK_FORM_ELEMENTS = {tagName: /^INPUT|SELECT|TEXTAREA|BUTTON$/i}, PRELOADING = 1, PRELOADED = 2, LOADING = 3, LOADED = 4, assets = {}, isAsync = null;
    BX.MSLEFT = 1;
    BX.MSMIDDLE = 2;
    BX.MSRIGHT = 4;
    BX.ext = function (e) {
    ...
    BX.html = function (e, t, n) {
        ...
        if (n.htmlFirst && typeof t.HTML != "undefined")e.innerHTML = t.HTML;
        var s = function () {
            if (!n.htmlFirst && typeof t.HTML != "undefined")e.innerHTML = t.HTML;
            for (var i in r)BX.evalGlobal(r[i]);
            if (BX.type.isFunction(n.callback))n.callback()
        };
        if (i.length > 0) {
            BX.load(i, s)
        } else s()
    ...
    BX.pos = function (e, t) {
        ...
        if (typeof e.getBoundingClientRect != "undefined" && e.ownerDocument == document && !t) {
            ...
            for (; e != null; e = e.offsetParent) {
                ...
                var c = parseInt(BX.style(e, "border-left-width")), p = parseInt(BX.style(e, "border-top-width"));
                if (!isNaN(c) && c > 0)a += c;
                if (!isNaN(p) && p > 0)l += p
            }
            n.top = l;
        ...
        var o = function (t) {
            ...
            if (!!e[t]) {
                ...
                if (isScriptLoaded(i)) {
                    ...
                    var s = n.getElementsByTagName("head")[0] || n.documentElement;
                    var a = n.createElement("script");
                    a.src = e[t];
                    var l = false;
                    a.onload = a.onreadystatechange = function () {
                        if (!l && (!a.readyState || a.readyState == "loaded" || a.readyState == "complete")) {
                            l = true;
                            setTimeout(function () {
                                o(++t)
                            }, 50);
    ...
    BX.formatDate = function (e, t) {
        e = e || new Date;
        var n = e.getHours() || e.getMinutes() || e.getSeconds(), i = !!t ? t : n ? BX.message("FORMAT_DATETIME") : BX.message("FORMAT_DATE");
    ...
    BX.parseDate = function (e, t, n, i) {
        if (BX.type.isNotEmptyString(e)) {
            ...
            if (c["DD"] > 0 && c["MM"] > 0 && c["YYYY"] > 0) {
                ...
                if ((!isNaN(c["HH"]) || !isNaN(c["GG"]) || !isNaN(c["H"]) || !isNaN(c["G"])) && !isNaN(c["MI"])) {
    ...
    BX.data = function (e, t, n) {
        ...
        if (typeof n != "undefined") {
            ...
            if ((i = dataStorage.get(e, t)) != undefined) {
                ...
                if ("getAttribute" in e && (i = e.getAttribute("data-" + t.toString())))return i
            }
            return undefined
        }
    };
    ...
    BX.FixFontSize.prototype = {
        createTestNodes: function () {
            ...
            var e = this.objList[0].scaleBy || this.objList[0].node, t = getComputedStyle(e), n = parseInt(t["width"]) - parseInt(t["paddingLeft"]) - parseInt(t["paddingRight"]);
...
/* End */
;
;/* Start:"a:4:{s:4:"full";s:53:"/bitrix/js/main/core/core_ajax.min.js?148544787120978";s:6:"source";s:33:"/bitrix/js/main/core/core_ajax.js";s:3:"min";s:37:"/bitrix/js/main/core/core_ajax.min.js";s:3:"map";s:37:"/bitrix/js/main/core/core_ajax.map.js";}"*/
(function (e) {
    if (e.BX.ajax)return;
    var a = e.BX, t = {}, r = {
        method: "GET",
    ...
    a.ajax = function (e) {
        ...
        for (var i in t)if (typeof e[i] == "undefined")e[i] = t[i];
        t = {};
        for (i in r)if (typeof e[i] == "undefined")e[i] = r[i];
        ...
        if (l) {
            ...
            if (typeof e.headers == "object") {
                for (i = 0; i < e.headers.length; i++)e.xhr.setRequestHeader(e.headers[i].name, e.headers[i].value)
            }
            if (!!e.onprogress) {
                    ...
                    if (e.xhr.readyState == 4 || t == "run") {
                        ...
                        if (o == "success") {
                            ...
                            if (!!r && r == "Authorize") {
                                ...
                                if (e.lsId) {
                                    a.localStorage.set("ajax-" + e.lsId, s, e.lsTimeout)
                                }
                                a.ajax.__run(e, s)
                            }
                        } else {
    ...
    a.ajax.__prepareOnload = function (t) {
        if (t.length > 0) {
            ...
            for (var r = 0, s = t.length; r < s; r++) {
                if (t[r].isInternal) {
                    t[r].JS = t[r].JS.replace(n.script_onload, "BX.ajax.onload_" + o)
                }
            }
        }
        a.CaptureEventsGet();
    ...
    a.ajax.processRequestData = function (e, t) {
        ...
        switch (t.dataType.toUpperCase()) {
            case"JSON":
                ...
                if (!!r && a.type.isArray(r["bxjs"])) {
                    for (var n = 0; n < r["bxjs"].length; n++) {
                        if (a.type.isNotEmptyString(r["bxjs"][n])) {
                            s.push({isInternal: false, JS: r["bxjs"][n], bRunFirst: t.scriptsRunFirst})
                        } else {
                            s.push(r["bxjs"][n])
                        }
                    }
                ...
                break;
            case"SCRIPT":
                s.push({isInternal: true, JS: e, bRunFirst: t.scriptsRunFirst});
                r = e;
                break;
            default:
        ...
        if (i.length > 0)a.loadCSS(i);
        if (t.emulateOnload)a.ajax.__prepareOnload(s);
        var c = a.DoNothing;
    ...
    a.ajax.processScripts = function (e, t, r) {
        ...
        for (var i = 0, n = e.length; i < n; i++) {
            if (typeof t != "undefined" && t != !!e[i].bRunFirst)continue;
            if (e[i].isInternal)s += ";" + e[i].JS; else o.push(e[i].JS)
        }
        ...
        if (a.type.isString(e))r = e; else if (null != e) {
            for (var o in e) {
                if (e.hasOwnProperty(o)) {
                    ...
                    if (t)s = t + "[" + s + "]";
                    if (typeof e[o] == "object")r += a.ajax.prepareData(e[o], s); else r += s + "=" + a.util.urlencode(e[o])
                }
            }
        }
        return r
    ...
    a.ajax.loadScriptAjax = function (e, t, r) {
        if (a.type.isArray(e)) {
            ...
            if (n.script_self.test(u))return;
            if (n.script_self_window.test(u) && a.CWindow)return;
            if (n.script_self_admin.test(u) && a.admin)return;
    ...
    a.ajax.prepareForm = function (e, a) {
        ...
        if (!!e) {
            for (t = 0; t < i; t++) {
                ...
                switch (o.type.toLowerCase()) {
                    ...
                    case"hidden":
                    case"select-one":
                        s.push({name: o.name, value: o.value});
                    ...
                    case"file":
                        if (!!o.files) {
                            for (r = 0; r < o.files.length; r++) {
                                n++;
                                s.push({name: o.name, value: o.files[r], file: true});
                                u += o.files[r].size
                            }
                        }
                        break;
                    ...
                    case"select-multiple":
                        for (var l = 0; l < o.options.length; l++) {
                            if (o.options[l].selected) {
                                s.push({name: o.name, value: o.options[l].value});
        ...
        return {data: a, filesCount: n, roughSize: u}
    };
    a.ajax.submitAjax = function (t, r) {
        ...
        if (!e["FormData"]) {
                    ...
                    if (typeof e == "object") {
                        for (var r in e) {
                            if (e.hasOwnProperty(r)) {
                                ...
                                if (typeof e[r] == "object" && e[r]["file"] !== true)t[o] = i(e[r]); else if (e[r]["file"] === true)t[o] = e[r]["value"]; else t[o] = a.util.urlencode(e[r])
                            }
                        }
            ...
            if (r.method !== "POST") {
                ...
                if (r.preparePost === true)r.data = i(r.data);
                s(n, "", r.data);
                r.data = n
            }
            r.preparePost = false;
            r.start = false;
            var u = a.ajax(r);
            if (!!r["onprogress"])u.upload.addEventListener("progress", function (e) {
                var a = null;
            ...
            var t = function (r, o, s) {
                if (!!o && a.type.isArray(o.scripts)) {
                    for (var i = 0, n = e.SCRIPTS.length; i < n; i++) {
                        o.scripts.push({isInternal: false, JS: e.SCRIPTS[i]})
                    }
                } else {
    ...
    a.userOptions.save = function (e, t, r, o, s) {
        ...
        if (i != "")document.cookie = a.message("COOKIE_PREFIX") + "_LAST_SETTINGS=" + i + "&sessid=" + a.bitrix_sessid() + "; expires=Thu, 31 Dec 2020 23:59:59 GMT; path=/;";
                ...
                if (r != a.ajax.history.expected_hash) {
                    ...
                    if (o) {
                        ...
                        if (null != a.ajax.history.obFrame) {
                            ...
                            if (e.location.hash != s && e.location.hash != "#" + s)e.location.hash = s
                        }
                    }
                }
                a.ajax.history.obTimer = setTimeout(a.ajax.history.__hashListener, 500)
        ...
        checkRedirectFinish: function (t, r) {
            ...
            a.ready(function () {
                ...
                if (e == "view/" || e == "view%") {
                    ...
                    var n = "/bitrix/tools/ajax_redirector.php?hash=" + o;
    ...
    a.ajax.FormData.prototype.send = function (e, t, r, o) {
        ...
        if (this.features.readFormData && this.features.sendFormData) {
            ...
            for (var i in this.elements) {
                if (this.elements.hasOwnProperty(i))s.append(this.elements[i].name, this.elements[i].value)
            }
            for (i in this.files) {
                if (this.files.hasOwnProperty(i))s.append(this.files[i].name, this.files[i].value)
            }
            this.xhr.send(s)
        }
        return this.xhr
...
/* End */
;
;/* Start:"a:4:{s:4:"full";s:48:"/bitrix/js/main/json/json2.min.js?14854478713467";s:6:"source";s:33:"/bitrix/js/main/json/json2.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
;/* Start:"a:4:{s:4:"full";s:50:"/bitrix/js/main/core/core_ls.min.js?14854478717365";s:6:"source";s:31:"/bitrix/js/main/core/core_ls.js";s:3:"min";s:35:"/bitrix/js/main/core/core_ls.min.js";s:3:"map";s:35:"/bitrix/js/main/core/core_ls.map.js";}"*/
(function (e) {
...
/* End */
;
;/* Start:"a:4:{s:4:"full";s:45:"/bitrix/js/main/session.min.js?14854478712511";s:6:"source";s:26:"/bitrix/js/main/session.js";s:3:"min";s:30:"/bitrix/js/main/session.min.js";s:3:"map";s:30:"/bitrix/js/main/session.map.js";}"*/
function CBXSession() {
    var e = this;
    this.mess = {};
    this.timeout = null;
    ...
    this.CheckResult = function (t) {
        if (t == "SESSION_EXPIRED") {
            ...
            var n;
            if (t == "SESSION_CHANGED")n = e.timeout - 60; else n = e.activityInterval < 60 ? 60 : e.activityInterval > e.timeout ? e.timeout - 60 : e.activityInterval;
            var o = new Date;
...
/* End */
;
;/* Start:"a:4:{s:4:"full";s:55:"/bitrix/js/main/core/core_window.min.js?148544787174917";s:6:"source";s:35:"/bitrix/js/main/core/core_window.js";s:3:"min";s:39:"/bitrix/js/main/core/core_window.min.js";s:3:"map";s:39:"/bitrix/js/main/core/core_window.map.js";}"*/
(function (window) {
    ...
    BX.CWindow.prototype.Move = function (t, e) {
        ...
        if (this.SETTINGS.drag_restrict) {
            ...
            if (o > n.scrollHeight - a - i)o = n.scrollHeight - a - i;
            if (o < 0)o = 0
        }
    ...
    BX.CDialog.prototype.__adjustSizeEx = function () {
        ...
        while (t) {
            e += t.offsetHeight + parseInt(BX.style(t, "margin-top")) + parseInt(BX.style(t, "margin-bottom"));
            t = BX.nextSibling(t)
        }
    ...
    BX.CDialog.prototype.Show = function (t) {
        if (!this.PARAMS.content && this.PARAMS.content_url && BX.ajax && !t) {
            ...
            BX.ajax({
                method: s, dataType: "html", url: o, data: i, skipAuthCheck: true, onsuccess: BX.delegate(function (t) {
                    BX.closeWait(null, e);
                    this.SetContent(t || "&nbsp;");
    ...
    BX.CMenu.prototype.addItem = function (t) {
        ...
        if (t.SEPARATOR) {
            ...
            t.NODE = BX.create(!!t.LINK || BX.browser.IsIE() && !BX.browser.IsDoctype() ? "A" : "SPAN", {
                ...
                html: '<span class="bx-core-popup-menu-item-icon' + (t.GLOBAL_ICON ? " " + t.GLOBAL_ICON : "") + '"></span><span class="bx-core-popup-menu-item-text">' + t.TEXT + "</span>"
            });
            if (e && !t.DISABLED) {
...
/* End */
;
;/* Start:"a:4:{s:4:"full";s:54:"/bitrix/js/main/core/core_popup.min.js?148544787131170";s:6:"source";s:34:"/bitrix/js/main/core/core_popup.js";s:3:"min";s:38:"/bitrix/js/main/core/core_popup.min.js";s:3:"map";s:38:"/bitrix/js/main/core/core_popup.map.js";}"*/
(function (t) {
    if (BX.PopupWindowManager)return;
    BX.PopupWindowManager = {
        _popups: [], _currentPopup: null, create: function (t, e, o) {
            var i = -1;
            if ((i = this._getPopupIndex(t)) !== -1)return this._popups[i];
            ...
            BX.addCustomEvent(n, "onPopupDestroy", BX.delegate(this.onPopupDestroy, this));
            this._popups.push(n);
            return n
        }, onPopupShow: function (t) {
            if (this._currentPopup !== null)this._currentPopup.close();
            this._currentPopup = t
        }, onPopupClose: function (t) {
            this._currentPopup = null
        }, onPopupDestroy: function (t) {
            var e = -1;
            if ((e = this._getPopupIndex(t.uniquePopupId)) !== -1)this._popups = BX.util.deleteFromArray(this._popups, e)
            ...
            var e = -1;
            for (var o = 0; o < this._popups.length; o++)if (this._popups[o].uniquePopupId == t)return o;
            return e
        }
    };
    BX.PopupWindow = function (e, o, i) {
        ...
        if (this.params.events) {
            for (var n in this.params.events)BX.addCustomEvent(this, n, this.params.events[n])
        }
        ...
        var s = "popup-window";
        if (i.lightShadow)s += " popup-window-light";
        if (i.titleBar)s += i.lightShadow ? " popup-window-titlebar-light" : " popup-window-titlebar";
        if (i.className && BX.type.isNotEmptyString(i.className))s += " " + i.className;
        this.popupContainer.innerHTML = ['<table class="', s, '" cellspacing="0"> 		<tr class="popup-window-top-row"> 			<td class="popup-window-left-column"><div class="popup-window-left-spacer"></div></td> 			<td class="popup-window-center-column">', i.titleBar ? '<div class="popup-window-titlebar" id="popup-window-titlebar-' + e + '"></div>' : "", '</td> 			<td class="popup-window-right-column"><div class="popup-window-right-spacer"></div></td> 		</tr> 		<tr class="popup-window-content-row"> 			<td class="popup-window-left-column"></td> 			<td class="popup-window-center-column"><div class="popup-window-content" id="popup-window-content-', e, '"> 			</div></td> 			<td class="popup-window-right-column"></td> 		</tr> 		<tr class="popup-window-bottom-row"> 			<td class="popup-window-left-column"></td> 			<td class="popup-window-center-column"></td> 			<td class="popup-window-right-column"></td> 		</tr> 	</table>'].join("");
        this.appendContainer.appendChild(this.popupContainer);
        if (i.closeIcon) {
            this.popupContainer.appendChild(this.closeIcon = BX.create("a", {
                props: {
                    className: "popup-window-close-icon" + (i.titleBar ? " popup-window-titlebar-close-icon" : ""),
                    href: ""
                },
                style: typeof i.closeIcon == "object" ? i.closeIcon : {},
                events: {click: BX.proxy(this._onCloseIconClick, this)}
            }));
            if (BX.browser.IsIE())BX.adjust(this.closeIcon, {attrs: {hidefocus: "true"}})
        }
        this.contentContainer = BX("popup-window-content-" + e);
        this.titleBar = BX("popup-window-titlebar-" + e);
        this.buttonsContainer = this.buttonsHr = null;
        if (i.angle)this.setAngle(i.angle);
    ...
    BX.PopupWindow.prototype.setContent = function (t) {
        if (!this.contentContainer || !t)return;
        if (BX.type.isElementNode(t)) {
        ...
        } else this.contentContainer.innerHTML = "&nbsp;"
    };
    BX.PopupWindow.prototype.setButtons = function (t) {
        this.buttons = t && BX.type.isArray(t) ? t : [];
        if (this.buttonsHr)BX.remove(this.buttonsHr);
        if (this.buttonsContainer)BX.remove(this.buttonsContainer);
        if (this.buttons.length > 0 && this.contentContainer) {
            var e = [];
            for (var o = 0; o < this.buttons.length; o++) {
                var i = this.buttons[o];
                if (i == null || !BX.is_subclass_of(i, BX.PopupWindowButton))continue;
                i.popupWindow = this;
                e.push(i.render())
            }
            this.buttonsHr = this.contentContainer.parentNode.appendChild(BX.create("div", {
    ...
    BX.PopupWindow.prototype.setBindElement = function (t) {
        ...
        if (BX.type.isDomNode(t) || BX.type.isNumber(t.top) && BX.type.isNumber(t.left))this.bindElement = t; else if (BX.type.isNumber(t.clientX) && BX.type.isNumber(t.clientY)) {
            BX.fixEventPageXY(t);
    ...
    BX.PopupWindow.prototype.getBindElementPos = function (t) {
        if (BX.type.isDomNode(t)) {
            ...
            if (!BX.type.isNumber(t.bottom))t.bottom = t.top;
            return t
        } else {
            var e = BX.GetWindowInnerSize();
    ...
    BX.PopupWindow.prototype.setAngle = function (t) {
        var e = this.params.lightShadow ? "popup-window-light-angly" : "popup-window-angly";
        if (this.angle == null) {
            var o = this.bindOptions.position && this.bindOptions.position == "top" ? "bottom" : "top";
            var i = BX.PopupWindow.getOption(o == "top" ? "angleMinTop" : "angleMinBottom");
            var n = BX.type.isNumber(t.offset) ? t.offset : 0;
            var s = BX.PopupWindow.getOption("angleLeftOffset", null);
            if (n > 0 && BX.type.isNumber(s))n += s - BX.PopupWindow.defaultOptions.angleLeftOffset;
            this.angle = {
                element: BX.create("div", {props: {className: e + " " + e + "-" + o}}),
                position: o,
                offset: 0,
        ...
        if (typeof t == "object" && BX.type.isNumber(t.offset)) {
            ...
            if (this.angle.position == "top") {
                ...
                u = this.popupContainer.offsetWidth - BX.PopupWindow.getOption("angleMaxTop");
                ...
                u = this.popupContainer.offsetWidth - BX.PopupWindow.getOption("angleMaxBottom");
                u = u < a ? Math.max(a, p) : u;
                this.angle.offset = Math.min(Math.max(a, p), u);
                ...
                u = this.popupContainer.offsetHeight - BX.PopupWindow.getOption("angleMaxRight");
                u = u < a ? Math.max(a, p) : u;
                this.angle.offset = Math.min(Math.max(a, p), u);
                this.angle.element.style.top = this.angle.offset + "px"
            } else if (this.angle.position == "left") {
                a = BX.PopupWindow.getOption("angleMinLeft");
                u = this.popupContainer.offsetHeight - BX.PopupWindow.getOption("angleMaxLeft");
                u = u < a ? Math.max(a, p) : u;
                this.angle.offset = Math.min(Math.max(a, p), u);
                this.angle.element.style.top = this.angle.offset + "px"
            }
    ...
    BX.PopupWindow.prototype.setOffset = function (t) {
        ...
        if (t.offsetLeft && BX.type.isNumber(t.offsetLeft))this.offsetLeft = t.offsetLeft + BX.PopupWindow.getOption("offsetLeft");
        if (t.offsetTop && BX.type.isNumber(t.offsetTop))this.offsetTop = t.offsetTop + BX.PopupWindow.getOption("offsetTop")
    };
    BX.PopupWindow.prototype.setTitleBar = function (t) {
        if (!this.titleBar || typeof t != "object" || !BX.type.isDomNode(t.content))return;
    ...
    BX.PopupWindow.prototype.setOverlay = function (t) {
        ...
        if (t && t.opacity && BX.type.isNumber(t.opacity) && t.opacity >= 0 && t.opacity <= 100) {
            if (BX.browser.IsIE() && !BX.browser.IsIE9())this.overlay.element.style.filter = "alpha(opacity=" + t.opacity + ")"; else {
                this.overlay.element.style.filter = "none";
                this.overlay.element.style.opacity = parseFloat(t.opacity / 100).toPrecision(3)
            }
        }
        if (t && t.backgroundColor)this.overlay.element.style.backgroundColor = t.backgroundColor
    };
    BX.PopupWindow.prototype.removeOverlay = function () {
        if (this.overlay != null && this.overlay.element != null)BX.remove(this.overlay.element);
        this.overlay = null
    };
    BX.PopupWindow.prototype.hideOverlay = function () {
        if (this.overlay != null && this.overlay.element != null)this.overlay.element.style.display = "none"
    };
    ...
    BX.PopupWindow.prototype.getZindex = function () {
        if (this.overlay != null)return BX.PopupWindow.getOption("popupOverlayZindex") + this.params.zIndex; else return BX.PopupWindow.getOption("popupZindex") + this.params.zIndex
    };
    ...
    BX.PopupWindow.prototype.close = function (t) {
        ...
        if (t && !(BX.getEventButton(t) & BX.MSLEFT))return true;
    ...
    BX.PopupWindow.prototype.eventFullScreen = function (e) {
        if (BX.PopupWindow.fullscreenStatus) {
            if (BX.browser.IsChrome() || BX.browser.IsSafari())BX.unbind(t, "webkitfullscreenchange", this.fullscreenBind); else if (BX.browser.IsFirefox())BX.unbind(t, "mozfullscreenchange", this.fullscreenBind);
    ...
    BX.PopupWindow.prototype.adjustPosition = function (t) {
        if (t && typeof t == "object")this.bindOptions = t;
        ...
        var a = this.bindElementPos.left + this.offsetLeft - (this.isTopOrBottomAngle() ? BX.PopupWindow.getOption("angleLeftOffset") : 0);
        if (!this.bindOptions.forceLeft && a + n + this.bordersWidth >= o.innerWidth + i.scrollLeft && o.innerWidth + i.scrollLeft - n - this.bordersWidth > 0) {
            var u = a;
            a = o.innerWidth + i.scrollLeft - n - this.bordersWidth;
            if (this.isTopOrBottomAngle()) {
                this.setAngle({offset: u - a + this.angle.defaultOffset})
            }
        } else if (this.isTopOrBottomAngle()) {
            this.setAngle({offset: this.angle.defaultOffset + (a < 0 ? a : 0)})
        }
        if (a < 0)a = 0;
        var r = 0;
        if (this.bindOptions.position && this.bindOptions.position == "top") {
            ...
            if (!this.bindOptions.forceTop && r + s > o.innerHeight + i.scrollTop && this.bindElementPos.top - s - this.getAngleHeight() >= 0) {
        ...
        if (!this.parentPopup && r < 0)r = 0;
        BX.adjust(this.popupContainer, {style: {top: r + "px", left: a + "px", zIndex: this.getZindex()}});
        this.adjustOverlayZindex()
    };
    ...
    BX.PopupWindow.prototype.move = function (t, e) {
        ...
        if (typeof this.params.draggable == "object" && this.params.draggable.restrict) {
            if (!this.parentPopup && o < 0)o = 0;
            var n = BX.GetWindowScrollSize();
            var s = this.popupContainer.offsetWidth;
            var p = this.popupContainer.offsetHeight;
            if (o > n.scrollWidth - s)o = n.scrollWidth - s;
            if (i > n.scrollHeight - p)i = n.scrollHeight - p;
            if (!this.parentPopup && i < 0)i = 0
        }
    ...
    BX.PopupWindow.prototype._moveDrag = function (e) {
        e = e || t.event;
        BX.fixEventPageXY(e);
        if (this.dragPageX == e.pageX && this.dragPageY == e.pageY)return;
    ...
    BX.PopupWindow.setOptions = function (t) {
        if (!t || typeof t != "object")return;
        for (var e in t)BX.PopupWindow.options[e] = t[e]
    };
    BX.PopupWindow.getOption = function (t, e) {
        if (typeof BX.PopupWindow.options[t] != "undefined")return BX.PopupWindow.options[t]; else if (typeof e != "undefined")return e; else return BX.PopupWindow.defaultOptions[t]
    };
    BX.PopupWindowButton = function (t) {
        ...
        this.contextEvents = {};
        for (var e in this.events)this.contextEvents[e] = BX.proxy(this.events[e], this);
        ...
        this.buttonNode = BX.create("span", {
            ...
            children: [BX.create("span", {props: {className: "popup-window-button-left"}}), this.nameNode, BX.create("span", {props: {className: "popup-window-button-right"}})],
    ...
    BX.PopupWindowButton.prototype.setClassName = function (t) {
        if (this.buttonNode) {
            if (BX.type.isString(this.className) && this.className != "")BX.removeClass(this.buttonNode, this.className);
    ...
    BX.PopupWindowButtonLink = function (t) {
        ...
        this.nameNode = BX.create("span", {
            props: {className: "popup-window-button-link-text"},
            text: this.text,
            events: this.contextEvents
        });
        this.buttonNode = BX.create("span", {
    ...
    BX.PopupMenu = {
        Data: {}, currentItem: null, show: function (t, e, o, i) {
    ...
    BX.PopupMenuWindow.prototype.__createItem = function (t, e) {
        if (e > 0) {
            t.layout.hr = BX.create("div", {props: {className: "popup-window-hr"}, children: [BX.create("i", {})]})
        }
        if (t.delimiter) {
            t.layout.item = BX.create("span", {props: {className: "popup-window-delimiter"}, html: "<i></i>"})
        } else {
            t.layout.item = BX.create(!!t.href ? "a" : "span", {
                props: {className: "menu-popup-item" + (BX.type.isNotEmptyString(t.className) ? " " + t.className : " menu-popup-no-icon")},
                attrs: {
                    title: t.title ? t.title : "",
                    onclick: t.onclick && BX.type.isString(t.onclick) ? t.onclick : "",
                    target: t.target ? t.target : ""
                },
                events: t.onclick && BX.type.isFunction(t.onclick) ? {
                    click: BX.proxy(this.onItemClick, {
                        obj: this,
                        item: t
                    })
                } : null,
                children: [BX.create("span", {props: {className: "menu-popup-item-left"}}), BX.create("span", {props: {className: "menu-popup-item-icon"}}), t.layout.text = BX.create("span", {
                    props: {className: "menu-popup-item-text"},
                    html: t.text
                }), BX.create("span", {props: {className: "menu-popup-item-right"}})]
            });
            if (t.href)t.layout.item.href = t.href
        }
        return t
    };
    BX.PopupMenuWindow.prototype.__createPopup = function () {
        ...
        var o = new BX.PopupWindow("menu-popup-" + this.id, this.bindElement, {
    ...
    BX.PopupMenuWindow.prototype.addMenuItem = function (t, e) {
        ...
        if (i != null) {
            if (i.layout.hr == null) {
                i.layout.hr = BX.create("div", {props: {className: "popup-window-hr"}, children: [BX.create("i", {})]});
    ...
    BX.PopupMenuWindow.prototype.__addMenuItem = function (t, e) {
        ...
        t.layout = {item: null, text: null, hr: null};
    ...
    BXInputPopup.prototype = {
        ShowPopup: function () {
            ...
            var t = this;
            if (!this.oPopup) {
                var e, o = BX.create("DIV", {props: {className: "bxecpl-loc-popup " + this.className}});
                for (var i = 0, n = this.values.length; i < n; i++) {
                    ...
                    if (this.values[i].DESCRIPTION)e.title = this.values[i].DESCRIPTION;
                    if (this.values[i].CLASS_NAME)BX.addClass(e, this.values[i].CLASS_NAME);
                    if (this.values[i].URL)e.appendChild(BX.create("A", {
                        props: {
            ...
            for (var e = 0, o = this.values.length; e < o; e++)if (this.values[e].ID == t)return e;
            return false
...
/* End */
;
;/* Start:"a:4:{s:4:"full";s:53:"/bitrix/js/main/core/core_date.min.js?148544787134276";s:6:"source";s:33:"/bitrix/js/main/core/core_date.js";s:3:"min";s:37:"/bitrix/js/main/core/core_date.min.js";s:3:"map";s:37:"/bitrix/js/main/core/core_date.map.js";}"*/
(function () {
    if (BX.date)return;
    BX.date = {};
    ...
    BX.JCCalendar = function () {
        ...
        this._check_time = function (e, t, a) {
            var i = parseInt(this.PARTS.TIME_INPUT_H.value.substring(0, 5), 10) || 0, s = parseInt(this.PARTS.TIME_INPUT_M.value.substring(0, 5), 10) || 0, r = false;
            if (!!e && !e.bSaveValue) {
        ...
        this._set_layer = function () {
            ...
            if (this._current_layer) {
                ...
                }, true), i = BX.findChild(this._layers[e], {tag: "A", attr: {"data-date": t.valueOf() + ""}}, true);
                if (a) {
...
/* End */
;
;/* Start:"a:4:{s:4:"full";s:44:"/bitrix/js/main/utils.min.js?148544787119858";s:6:"source";s:24:"/bitrix/js/main/utils.js";s:3:"min";s:28:"/bitrix/js/main/utils.min.js";s:3:"map";s:28:"/bitrix/js/main/utils.map.js";}"*/
var phpVars;
if (!phpVars) {
    phpVars = {
...
/* End */
;
;/* Start:"a:4:{s:4:"full";s:50:"/bitrix/js/main/core/core_fx.min.js?14854478719592";s:6:"source";s:31:"/bitrix/js/main/core/core_fx.js";s:3:"min";s:35:"/bitrix/js/main/core/core_fx.min.js";s:3:"map";s:35:"/bitrix/js/main/core/core_fx.map.js";}"*/
(function (t) {
    ...
    BX.fx.EFFECTS = {
        scroll: function (t, e, s) {
            ...
            if (s == 0)var a = o, r = e.min_height ? parseInt(e.min_height) : 0; else var r = o, a = e.min_height ? parseInt(e.min_height) : 0;
            return {
    ...
    BX.easing.prototype.stop = function (t) {
        if (this.timer) {
            ...
            this.timer = null;
            if (t)this.options.complete && this.options.complete()
        }
    };
